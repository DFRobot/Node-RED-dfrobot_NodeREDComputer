...
const request_url = "http://10.1.2.3:5000/peripheral/iic";

module.exports = function(RED) {

    function peripheral_IIC_Node(config) {
...
// ---------------------------------------------------mqtt部分-----------------------------
        ...
        client.on('connect', function () {
            ...
            client.subscribe(`peripheral/iic/${uniqueId}`, { qos: 0 });
        ...
        node.on('input', function(msg) {
            ...
            if(msg.payload.hasOwnProperty('command')){
                postPayload.command = msg.payload.command
            }
    ...
    RED.nodes.registerType("IIC通信", peripheral_IIC_Node);
};
